...
% simple - 1/0. simple=1 only computes autocorrelations, without graphics
...
if ~simple
    % TO INCREASE SPEED, WE MAY NOT WANT TO RUN THE CODE THAT FOLLOWS.
