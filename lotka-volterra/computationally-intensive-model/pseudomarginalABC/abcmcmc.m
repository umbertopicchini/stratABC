function MCMC = abcmcmc(problem,data,bigtheta,simultime,sampletime,stoichiometry,parmask,parbase,R_mcmc,step_rw,burnin,length_CoVupdate,covar,ABCthreshold,numsim)
...
for mcmc_iter = 1:R_mcmc
    ...
    for ii=1:numsim
       simdata= feval([problem, '_model'],bigtheta,simultime,sampletime,stoichiometry,1); 
