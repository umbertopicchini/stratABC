...
tStart = tic; 
ABCMCMC = abcmcmc(problem,yobs,bigtheta_start,simultime,sampletime,stoichiometry,parmask,parbase,R_mcmc,step_rw,burnin,length_CoVupdate,summ_weights,ABCthreshold,numsim);
