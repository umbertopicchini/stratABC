function [ABCMCMC,summariesmatrix] = abcmcmc(problem,data,bigtheta,parmask,parbase,covariates,threshold_vec,updatethreshold,R_mcmc,step_rw,weights,length_CoVupdate)
...
simuldata_old = feval([problem, '_modelsimulate'],bigtheta,covariates,1); 
summsimuldata_old = feval([problem, '_abc_summaries'],simuldata_old);
summariesmatrix(1,:) = summsimuldata_old;

invcovmatrix = 1./weights.^2;
...
simuldata = feval([problem, '_modelsimulate'],bigtheta,covariates,1); 
