...
% Some of the following summaries are from Drovandi and Pettitt 2011, Likelihood-free Bayesian estimation of multivariate quantile distributions
...
%    summariesy(5,:) = prctile(y,30);
%    summariesy(6,:) = prctile(y,70); 
%    summariesy(7,:) = prctile(y,80);

 %summariesy = log(summariesy+50);
