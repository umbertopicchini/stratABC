...
numsimABC = 1;  % DO NOT MODIFY. This means that we simulate from the model only once for the training and once for the testing. 
...
ABCquantile = 5;   % this was equal to 3 in the paper. It is the alpha-quantile for the computation of the ABC threshold
frequency_threshold_upd = 500; % how often should we check whether we can reduce the ABC threshold
kernel = 'gauss';  % DO NOT MODIFY THIS
adaptation = 'am';   % % DO NOT MODIFY THIS
switch adaptation
